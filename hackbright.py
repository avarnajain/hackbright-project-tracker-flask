...
def get_grade_by_github_title(github, title):
    ...
    print("Student {} in project {} received grade of {}".format(github, title,
        row[0]))
...
def assign_grade(github, title, grade):
    ...
    print("Successfully assigned grade of {} for {} in {}".format(grade,
        github, title))
...
def get_grades_by_github(github):
    ...
    for row in rows:
        print("Student {} received grade of {} for {}".format(github, row[1],
            row[0]))
...
def get_grades_by_title(title):
    ...
    for row in rows:
        print("Student {} received grade of {} for {}".format(row[0],
            row[1], title))
